...
public class CidadesController extends DaoImplementacao<Cidades> implements DaoInterface<Cidades> {
	...
	@ResponseBody
	public String listarChrome(@RequestParam("idEstado") String idEstado) throws NumberFormatException, Exception {
		return new Gson().toJson(lista(Long.parseLong(idEstado)));
	}

	/**
	 * Faz o carregamento das ciadades de acordo com os estado
	 * 
	 * @param codigoEstado
	 * @return List<Cidades>
