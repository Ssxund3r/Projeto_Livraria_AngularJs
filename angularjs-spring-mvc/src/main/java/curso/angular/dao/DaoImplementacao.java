...
/**
 * Implementacao dos metodos padroes da interface de acesso ao banco de
 * operacoes
 * 
 * @author gabriel
 * @param <T>
...
public abstract class DaoImplementacao<T> implements DaoInterface<T> {
	...
	@Override
	public void salvar(T bojeto) throws Exception {
		sessionFactory.getCurrentSession().save(bojeto);
	...
	@Override
	@SuppressWarnings("unchecked")
	public T loadObjeto(Long codigo) {
